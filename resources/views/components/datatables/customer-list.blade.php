<div>
    ...
    <!--end::Wrapper-->
    <table id="customerDatatable" class="table align-middle table-striped table-row-bordered fs-6 gy-5 gs-7">
        <thead>
    ...
    @push('scripts')
        <script>
                        ...
                        columnDefs: [
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                    <a href="/master/customer/form/`+data.id+`" class="menu-link px-3" data-kt-docs-table-filter="edit_row">
                                        Edit
                                    </a>
                                </div>
                                <!--end::Menu item-->
            ...
            function reloadCustomerDatatables()
            {
