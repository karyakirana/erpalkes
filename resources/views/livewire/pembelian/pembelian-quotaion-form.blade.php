                ...
                <div class="mb-0">
                    ...
                    <div class="row gx-10 mb-5">
                        ...
                        <div class="col-md-6">
                            ...
                            <!--begin::Input group-->
                            <div class="mb-5">
                                <input type="text" class="form-control form-control-solid" placeholder="Supplier" />
                            </div>
                            <!--end::Input group-->
                            <!--begin::Input group-->
                            <div class="mb-5">
                    ...
                    <div class="table-responsive mb-10">
                        ...
                        <table class="table g-5 gs-0 mb-0 fw-bold text-gray-700" data-kt-element="items">
                            ...
                            <tr class="border-bottom fs-7 fw-bold text-gray-700 text-uppercase">
                                ...
                                <th class="min-w-100px w-100px">Jumlah</th>
...
{{--                                    <button class="btn btn-link py-1" data-kt-element="add-item">Add item</button>--}}
                            ...
                            <tr class="border-top border-top-dashed align-top fs-6 fw-bold text-gray-700">
                                ...
                                <th colspan="2" class="border-bottom border-bottom-dashed ps-0">
                                    <div class="d-flex flex-column align-items-start">
                                        <div class="fs-5">Diskon</div>
                                    </div>
                                </th>
                                <th colspan="2" class="border-bottom border-bottom-dashed text-end">
                                    <span data-kt-element="sub-total"> </span></th>
                            </tr>
        ...
        <div class="col-lg-4">
            <x-card.card-3 title="Tambah Produk" class="mt-5" data-kt-sticky="true" data-kt-sticky-name="quotation" data-kt-sticky-offset="{default: false, lg: '100px'}" data-kt-sticky-width="{lg: '300px', lg: '410px'}" data-kt-sticky-left="auto" data-kt-sticky-top="150px"  data-kt-sticky-animation="true" data-kt-sticky-zindex="95">
                <div class="row">
                    ...
                    <div class="col-12">
                        <x-input.group-vertical label="Status" name="status">
                            <x-input.text />
                        </x-input.group-vertical>
                    </div>
                    <div class="col-5">
                    ...
                    <div class="text-center pb-4 pt-5">
                        ...
                        @else
                            <x-button.btn-base >Save All</x-button.btn-base>
                        @endif
                    </div>
                </div>
                {{--            <x-slot:footer>--}}
