<x-metronics-layout>
    <x-card.standart title="Data Quotation" class="mt-5">
        <!--begin::Wrapper-->
        <div class="d-flex flex-stack mb-5">
            ...
            <div class="d-flex justify-content-end" data-kt-quotation-table-toolbar="base">
                <!--begin::Add customer-->
                <x-button.btn-link-base href="{{route('pembelian.quotation.form')}}">
            ...
            var KTDatatablesServerSide = function () {
                ...
                let initDatatable = function () {
                    dt = $("#quotationDatatable").DataTable({
                        ...
                        ajax: {
                            type: 'post',
                            url: "{{route('pembelian.quotation.datatables')}}",
                        },
                        columns: [
                            { data: 'kode' },
                            { data: 'tgl_quotation' },
                ...
                let handleSearchDatatable = function () {
                    const filterSearch = document.querySelector('[data-kt-quotation-table-filter="search"]');
            ...
            function destroy(id)
            {
                Swal.fire({
                    ...
                    if(result.isConfirmed){
                        $.ajax({
                            url : '{{route("penjualan.quotation.destroy")}}',
                            method : 'delete',
                            data : {
                                id : id
                            },
